 ...
 */
"use strict";var hasSymbols=_dereq_("has-symbol-support-x"),toPrimitive=_dereq_("to-primitive-x"),toStr=_dereq_("to-string-x"),symbolToStr=hasSymbols&&Symbol.prototype.toString;module.exports=function toPropertyKey(argument){var key=toPrimitive(argument,String);return hasSymbols&&"symbol"==typeof key?symbolToStr.call(key):toStr(key)}},{"has-symbol-support-x":2,"to-primitive-x":14,"to-string-x":16}],2:[function(_dereq_,module,exports){/**
